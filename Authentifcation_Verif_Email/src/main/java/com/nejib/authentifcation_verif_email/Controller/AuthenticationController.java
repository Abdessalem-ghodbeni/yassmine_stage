...
import com.nejib.authentifcation_verif_email.Services.ServiceImpl.IUserServicesImp;
...
public class AuthenticationController {
    ...
    private final IUserServicesImp userServicesImp;
 ...
 ;
    ...
    public List<User> allUser() {
        return userServicesImp.FetAllUser();
    }

@PutMapping(path = "desactivate/{id_user}")
public ResponseEntity<?> desactivate(@PathVariable("id_user") Long id_user) {
    User user = userServicesImp.DsactivateUser(id_user);
    return new ResponseEntity<>(user, HttpStatus.CREATED);
}

    @PutMapping(path = "activate/{id_user}")
    public ResponseEntity<?> activate(@PathVariable("id_user") Long id_user) {
        User user = userServicesImp.activateUser(id_user);
        return new ResponseEntity<>(user, HttpStatus.CREATED);
    }
}
